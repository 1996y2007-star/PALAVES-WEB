      ...
      <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          <div className="relative aspect-[4/5] max-w-md mx-auto lg:mx-0">
            ...
            <img
              src="https://images.unsplash.com/photo-1520341280432-4740d447a2a2?q=80&w=800&auto=format&fit=crop"
        ...
        >
          <div className="section-title text-left items-start p-0">
            ...
            <p className="mb-6">
              ¡Hola! Soy Santiago, un fotógrafo apasionado por contar historias a través de mi lente. Mi objetivo es capturar la esencia de cada momento, la emoción genuina y los detalles que hacen que cada evento sea único.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 p-4 bg-primary-50/50 border-l-4 border-accent rounded-r-lg">
            ...
            <p className="font-medium text-warm-gray-800">
              Mi misión es simple: entregarte recuerdos que te hagan sonreír, llorar de alegría y revivir tu día especial una y otra vez.
            </p>
          </div>
        </motion.div>
      </div>
